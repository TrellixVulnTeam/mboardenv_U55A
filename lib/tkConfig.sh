...
# installed.
TK_PREFIX='/home/ubuntu/conda/envs/madboard'

# Top-level directory in which Tk's platform-specific files (e.g.
# executables) are installed.
TK_EXEC_PREFIX='/home/ubuntu/conda/envs/madboard'
...
# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-L/home/ubuntu/conda/envs/madboard/lib -ltk8.6'

# String to pass to the compiler so that an extension can
# find installed Tk headers.
TK_INCLUDE_SPEC='-I/home/ubuntu/conda/envs/madboard/include'
...
# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-L/home/ubuntu/conda/envs/madboard/lib -ltkstub8.6'
...
TK_STUB_LIB_PATH='/home/ubuntu/conda/envs/madboard/lib/libtkstub8.6.a'
